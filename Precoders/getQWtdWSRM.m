            ...
            while re_iterate
                ...
                for iUser = 1:nUsers
                    ...
                    for iSB = 1:nSB
                        ...
                        norm(if_vector,2) <= sqrt(b_k_n(iUser,iSB));
                        log(g_k_n(iUser,iSB)) >= t_k_n(iUser,iSB);
                        
                        r_M_k_n(iUser,iSB) = real(cCH * M_k_n(:,iUser,iSB));
                        i_M_k_n(iUser,iSB) = imag(cCH * M_k_n(:,iUser,iSB));
                        
                        (r_M_k_n_o(iUser,iSB)^2 + i_M_k_n_o(iUser,iSB)^2) + 2 * (r_M_k_n_o(iUser,iSB) * (r_M_k_n(iUser,iSB) - r_M_k_n_o(iUser,iSB)) + ...
                            i_M_k_n_o(iUser,iSB) * (i_M_k_n(iUser,iSB) - i_M_k_n_o(iUser,iSB))) + b_k_n(iUser,iSB) >= ...
                            0.5 * (phi_k_n(iUser,iSB) * g_k_n(iUser,iSB)^2 + (1 / phi_k_n(iUser,iSB)) * b_k_n(iUser,iSB)^2);
