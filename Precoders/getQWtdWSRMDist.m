        ...
        while scaContinue
            ...
            while masterContinue
                ...
                for iBase = 1:nBases
                    ...
                    epiObjective >= norm(userObjective,1) + tempFirst - tempSecond + tempADMM * alpha;
...
if strcmp(dualEvaluateAgain,'true')
    
    nLayers = SimParams.maxRank;
    
    currentIF = 0;
    for iBase = 1:nBases
        currentIF = currentIF + cellX{iBase,1};
    end
    
    currentIF = currentIF ./ nBases;
